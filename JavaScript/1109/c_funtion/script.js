...
// 1. 코드 재사용
// : 같은 코드를 여러번 작성하는 대신 함수를 정의하고 필요할때마다 호출하여 사용
...
log();  // 아규먼트를 넘기지 X - 출력: undefined
log(1);  // 인수를 하나 넘김 - 출력: 1
log(1, 2);  // 인수를 두개 이상 넘김 - 출력: 1
...
// subtract 함수의 반환값(3 - 5 = -2)이 subtractResult 변수에 저장
let subtractResult = subtract(3, 5);

//? return 키워드가 엇는 함수는 undefined를 반환
...
//? 반환값은 함수의 작업 결과를 함수 외부로 전달하는 방법
// : 함수의 반환값을 이용하여 함수의 결과를 다른 변수에 저장
// : || 다른 함수의 입력으로 사용하거나
// : || 조건문 또는 반복문에서 사용 가능
