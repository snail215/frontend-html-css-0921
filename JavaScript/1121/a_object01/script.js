...
// 한 쌍의 이름과 값은 ,(쉼표)로 구분되어야 하고 이름과 값은 :(클론)으로 분리
...
//! 5. 괄호 표기법
// 객체의 프로퍼티에 접근하는 방법
// : 배열의 요소값에 접근하는 것과 동일하게 인덱스 숫자를 대신하여 각 멤버의 값들과 연결된 이름을 이용하여 접근
// : 객체를 '연관배열'이라고도 불림.
...
// 객체 멤버를 설정하는 것은
// 기존의 존재하는 프로퍼티나 메소드를 새롭게 정의하는 것 뿐만이 아니라 완전히 새로운 멤버 생성도 가능
