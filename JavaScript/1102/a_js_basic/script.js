...
// 식별자
// : 개발자가 자바스크립트의 변수, 함수, 속성들을 구별하려고 이름 붙인 특정 단어
...
//? 4-2. 알림 창(대화상자) 출력 (alert:  알리다, 경고하다)

// alert()함수 사용
// : 소괄호 안에 출력한 메시지를 입력(매개변수, parameter)
alert('Hello world');
...
// 괄호 안에는 실제 웹 브라우저 화면에 표시할 내용(HTML 태그 사용 가능), 어떤 결괏값이 저장된 변수 삽입
// document.write();

document.write('<h1>자바스크립트 출력</h1>');

// 사용자로부터 입력받은 내용과 변수를 섞어서 나타낼수도 있음
