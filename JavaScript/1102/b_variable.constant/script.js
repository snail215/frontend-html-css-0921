/*
  ...
  ! 변수 선언
    ...
    , 값을 저장할 컴퓨터 메모리 공간게 이름을 붙이는 것

  ! 변수명 명명규칙
    - 첫 글자는 영문자, _ 언더스코어, $ 달러만 사용 가능(이후 숫자 사용 가능)
    - 띄어쓰기 허용 X
    - 기호는 _ , $ 만 사용 가능
    - 영어 대소문자 구별
  ...
  ! 자바스크립트의 변수 선언
    ...
    ? var
      : 함수 범위 변수(Block Scope)
      : 재할당 가능
      : 호이스팅O (선언 부분이 상단으로 끌어올려짐)
*/

let letVariable; // 변수선언
var varVariable; // 변수선언
