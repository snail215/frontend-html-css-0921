...
let numbers = [1, 2, 3, 4];
let sum = numbers.reduce((accumulator, currnetValue) => accumulator + currnetValue, 0);
console.log(sum);
...
// 데이터 사이에는 ', '
// let cars = ['audi', 'bmw', 'hyundai', 'volvo'];
let combinedCarNames = cars.reduce((accumulator, currnetValue) => accumulator + ', ' + currnetValue);
...
console.log(firstIndexOverFive);  // 0
