...
1. npm init
  : 새로운 Node.js 프로그램을 시작하고 기본값으로 package.json 파일을 생성
  : -y 옵션을 추가
...
? npm 초기화
  ...
  - 프로젝트의 시작점을 지정하거나 스크립트 정의 등의 기능 수행
